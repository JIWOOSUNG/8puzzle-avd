...
class PuzzleMapTest {
    ...
    void t11() throws Exception {
        puzzleMap.setMap(new int[][]{{1, 2, 3}, {4, 5, 6}, {8, 7, 9}});
        assertThat(puzzleMap.isNearbyEmptyBlock(puzzleMap.getMap()[1][2])).isEqualTo(true);
    }
    ...
    void t13() throws Exception {
        puzzleMap.setMap(new int[][]{{1, 2, 3}, {4, 5, 6}, {8, 7, 9}});
        assertThat(puzzleMap.isNearbyEmptyBlock(puzzleMap.getMap()[2][2])).isEqualTo(false);
    }
    @Test
